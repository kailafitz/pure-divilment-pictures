    ...
    creative: {
      ...
      bio: [
        <>
          ...
          leads the business end of Pure Divilment Pictures. She has experience
          across a wide variety of mediums from feature films to television
          content to animation and VFX.
        </>,
        <>
          ...
          Screen Finance from the National Film School.
        </>,
        <>
    ...
    creative: {
      ...
      bio: [
        ...
        <>
          ...
          <i>Silver</i> (Amazon Studios), Disney’s <i>Disenchanted</i>,{" "}
    ...
    creative: {
      ...
      bio: [
        ...
        <>
          ...
          co-production film <i>Sprachlos in Irland</i> (2020) for Ard 1 in her
          home county, Clare.
        </>,
        <>
          ...
          ivilment on both <i>Baths</i> and{" "}
          <i>Falling For The Life Of Alex Whelan</i>, as associate producer and
          line producer. She is currently based between Ireland and Vancouver,
          Canada.
        </>,
        <>
          ...
          and the power of music in visual narratives. She also has a passion
          for automobiles and is always on the hunt for a script with a good car
          chase!
        </>,
      ],
      credits: [],
